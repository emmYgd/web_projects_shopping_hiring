import AbstractModel from "./../../Models/AbstractModel.js";
	...
	{	
		...
		{
			let method = "POST";
			let UploadServerUrl = 'http://localhost/Hodaviah/Backend/public/api/v1/buyer/dashboard/utils/fetch/general/statistics';
		...
		FetchUI()
		{
			if(this.fetch_success)
			{
				...
				$('span#purchase_volume_average').text('');
				$('span#purchase_volume_average').text(this.serverSyncModel.statDetails.purchase_volume_average);
...
export default BuyerGeneralStatistics;
